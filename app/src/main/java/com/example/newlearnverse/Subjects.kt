...
import com.example.newlearnverse.components.SubjectCard
import com.example.newlearnverse.components.TopBar
import kotlinx.coroutines.launch

@Composable
fun SubjectScreenWTopBar(navController: NavHostController) {

    Scaffold { paddingValues ->
        Screen(modifier = Modifier.padding(paddingValues), navController)
